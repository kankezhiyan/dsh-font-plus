 ...
 * as the shipped ui-* packages. The font choice is persisted in
 * localStorage, because the Host settings wire only exposes an allowlisted
 * set of namespaces to browser clients, so a third-party namespace would
 * answer `settings-not-exposed`.
 */
